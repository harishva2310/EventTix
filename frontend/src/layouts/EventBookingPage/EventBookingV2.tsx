...
export default function EventDetailsPage() {
    ...
    return (
        <div className="container mx-auto py-8">
            <div className="bg-card rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300">
                <div className="p-8">
                    <EventHeroSection event={event} venue={venue} />
                    <EventPerformersSection eventDetails={event.event_details} />

                    <div className="mt-8 w-full bg-card shadow-lg rounded-lg p-6">
                                                    ...
                                                    <AccordionContent>
                                                        <div className="flex flex-col gap-4 max-w-[full]">
                                                            ...
                                                            {section.sectionSeating === "YES" ? (
                                                                // Seated Section
                                                                <div className="overflow-x-auto max-w-[100vw] sm:overflow-x-auto">
                                                                    <div
                                                                            style={{
                                                                                display: 'grid',
                                                                        ...
                                                                        <div className="flex flex-col gap-4">
                                                                                ...
                                                                                <CardContent>
                                                                                    <div className="flex items-center justify-between">
                                                                                        <div className="space-y-1">
                                                                                            <p className="text-sm text-muted-foreground">Select the number of tickets you need</p>
                                                                                            <p className="text-xs text-muted-foreground">Maximum 8 tickets for request</p>
                                                                                        </div>
                                                                            ...
                                                                            {standingTickets[section.sectionId] && (
                                                                                ...
                                                                                <CardHeader className="pb-3">
                                                                                    <CardTitle className="text-lg font-semibold">Available Tickets</CardTitle>
                                                                                </CardHeader>
                                                                                <CardContent>
                                                                                <p className="text-sm text-muted-foreground pb-3">Select the Tickets to add to the cart</p>
                                                                                    <div className="grid grid-cols-3 gap-3">
                                                                                        {standingTickets[section.sectionId].map((ticket) => (
                                                                                            <Toggle
                                                                                                ...
                                                                                                className="h-auto flex flex-col gap-2 p-4 data-[state=on]:bg-primary data-[state=on]:text-primary-foreground hover:bg-primary/10"
                                                                                            >
                                                                                                <span className="text-sm">Ticket #{ticket.ticketId}</span>
                                                                                                <span className="text-lg font-bold">${ticket.ticketPrice}</span>
                                                                                            </Toggle>
                                                                                        ))}
                                                                                    </div>
                                                                                </CardContent>
